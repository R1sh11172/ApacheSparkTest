...
public class IntroSections {
	public static void main(String[] args) {
		...
		JavaRDD<Tuple2<Integer, Double>> sqrtRdd2 = myRDD.map( value -> new Tuple2<> (value, Math.sqrt(value)) ); //because RDD are immutable
		...
		//counting num elements with map and reduce
